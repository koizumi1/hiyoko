<script type="text/javascript">
  function hogeChange(){
  	flg = document.getElementById('hiyoko-widgets-edit').style;
	re = new RegExp("step=2");
  		if (location.href.match(re)) {
  document.getElementById("hiyoko-widgets-edit").style.display="none";		
...
<form method="post" action="admin.php?page=custom-header">
